...
class DetailGambar3Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_gambar3)

        val gambarDetail3: ImageView = findViewById(R.id.gambarDetail3)
        ...
        val buttonPesan: Button = findViewById(R.id.button_pesan_gambar3)

        gambarDetail3.setImageResource(R.drawable.wisata3)
        namaTempatText.text = "Laut bantung"
        ...
        buttonPesan.setOnClickListener {
            ...
            intent.putExtra("ITEM_NAME", "Laut bantung")
