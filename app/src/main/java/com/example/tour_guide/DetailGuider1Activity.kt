...
class DetailGuider1Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_guider1)
        ...
        guider2_detail_image.setImageResource(R.drawable.foto1)
        guider2_detail_name.text = "Resti Kirana"
        guider2_detail_rating.setImageResource(R.drawable.iconstar)
        guider2_detail_price.text = "Rp. 50.000"
        ...
        buttonPesan.setOnClickListener {
            ...
            intent.putExtra("ITEM_NAME", "Resti Kirana")
            intent.putExtra("ITEM_PRICE", 50000.0)
